    ...
    <Flex flex={1} flexDirection="column" bg="background">
      ...
      <Box p={3} position="relative">
        ...
        <Box sx={{ visibility: ["hidden", "unset", "unset", "unset"] }}>
          <Flex mt={2}>
            <a target="_blank" href="https://discord.com/invite/NXEntTSHgy" rel="noreferrer">
            ...
            <a
              target="_blank"
              href="https://etherscan.io/address/0xff9c1b15b16263c61d017ee9f65c50e4ae0113d7#code" rel="noreferrer"
            >
